...
const postgresConnectionString = "postgres://davilson:@admin0001@localhost:5432/heroes"
const postgresContext = new ContextStrategy(new PostgresStrategy(postgresConnectionString))
await postgresContext.connect()

const mongoDbConnectionString = "mongodb://davilson:admin0001@localhost:27017/heroes"
